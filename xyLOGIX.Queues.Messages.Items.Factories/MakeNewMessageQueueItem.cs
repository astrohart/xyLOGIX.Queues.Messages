...
namespace xyLOGIX.Queues.Messages.Items.Factories
{
    ...
    public static class MakeNewMessageQueueItem
    {
        ...
        /// <see cref="M:SampleMVP.MessageQueueItem.AndHandler" /> method to associate the
