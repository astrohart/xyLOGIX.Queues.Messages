...
namespace xyLOGIX.Queues.Messages.Broadcasters
{
    ...
    /// <typeparamref name="T" />, to all interested parties throughout the
    /// application.
    /// </summary>
    /// <typeparam name="T">
    /// Name of the data type of the <c>class</c> or <c>struct</c>
    ...
    /// with message data having type <typeparamref name="T" />, and that do not
