...
namespace xyLOGIX.Queues.Messages
{
    ...
    /// </typeparam>
    /// <typeparam name="R">
    /// Name of the data type that carries the result of processing the message.
    /// </typeparam>
    /// <remarks>
    ...
    public class NewMessageMapping<T,R>
    {
        ...
        /// cref="T:xyLOGIX.Queues.Messages.NewMessageMapping{T}"/> and returns
        /// a reference to it.
        /// </summary>
        ...
        /// <para/>
        /// It is not required, nor is it even advisable, to call the <see
        /// cref="M:xyLOGIX.Queues.Messages.NewMessageMapping.WithMessageId"/>
        ...
        /// (Required.) A <see cref="T:System.Guid"/> that contains the unique
        ...
        /// <remarks>
        /// <para/>
        /// <b>NOTE:</b> You must call the <see
        ...
        /// to calling the <see
        /// cref="M:xyLOGIX.Queues.Messages.NewMessageMapping.AndHandler"/>
        /// method. If this is not done, then the <see
        /// cref="M:xyLOGIX.Queues.Messages.NewMessageMapping.AndHandler"/>
