...
namespace xyLOGIX.Queues.Messages.Extensions
{
    ...
    public static class DelegateExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="T">
        /// Name of the data type of the object that carries the
        /// message's data.
        /// </typeparam>
        /// <param name="d">
        /// (Required.) Reference to the <see cref="T:System.Delegate" />
        ...
        /// (Required.) Unique identifier (GUID) to be associated
        ...
        /// parameter, <paramref name="messageId" />, is passed a <see langword="null" />
        /// value.
        /// </exception>
        /// <exception cref="T:System.ArgumentException">
        /// Thrown if the Zero GUID is
        /// supplied for the <paramref name="messageId" /> parameter.
        /// <para />
