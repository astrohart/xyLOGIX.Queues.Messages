...
{
    /// <summary>
    /// Represents a single item in a <see cref="T:xyLOGIX.Queues.Messages.MessageQueue"/>.
    /// </summary>
    public class MessageQueueItem : IMessageQueueItem
    {
        ...
        /// <summary>
        /// Fluent-builder method that enables us to attach a <see
        ...
        /// <para/>
        /// The most common implementation is to remove the newly-built <see cref="T:xyLOGIX.Queues.Messages.Interfaces.IMessageQueueItem"/>
